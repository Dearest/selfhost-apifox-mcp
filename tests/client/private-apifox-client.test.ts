...
describe("PrivateApifoxClient", () => {
  it("请求自动带上鉴权与分支头", async () => {
    ...
    mock.onGet("https://example.apifox.com/api/v1/projects/345101/http-apis/1").reply(200, {
      success: true,
      data: {
        id: 1,
        name: "查询用户",
    ...
    const client = new PrivateApifoxClient({
      ...
      baseUrl: "https://example.apifox.com",
      projectId: 345101,
      branchId: 0,
      clientVersion: "2.7.2",
      clientMode: "web",
  ...
  it("401 时强制刷新 token 后重试一次", async () => {
    ...
    mock.onGet("https://example.apifox.com/api/v1/projects/345101/http-apis/1").replyOnce(401, { success: false })
    mock.onGet("https://example.apifox.com/api/v1/projects/345101/http-apis/1").replyOnce(200, {
      success: true,
      data: {
        id: 1,
        name: "查询用户",
  ...
  it("updateApi 支持 success=true 且 data=null 的返回", async () => {
    ...
    mock.onPut("https://example.apifox.com/api/v1/api-details/3474867").replyOnce(200, {
      success: true,
      data: null,
    })
    ...
    expect(mock.history.put[0]?.headers?.["Content-Type"]).toContain("application/x-www-form-urlencoded")
  ...
  it("createApi 会注入默认字段并使用 x-www-form-urlencoded", async () => {
    ...
    mock.onPost("https://example.apifox.com/api/v1/api-details").replyOnce(200, {
      success: true,
      data: {
        id: 3483321,
    ...
    expect(mock.history.post[0]?.headers?.["Content-Type"]).toContain("application/x-www-form-urlencoded")
